...
func CreateApp(cf string) (*app.Application, error) {
	...
	reviewsRepository := repositorys.NewMysqlReviewsRepository(logger, db)
...
var providerSet = wire.NewSet(log.ProviderSet, config.ProviderSet, database.ProviderSet, services.ProviderSet, consul.ProviderSet, jaeger.ProviderSet, http.ProviderSet, grpc.ProviderSet, reviews.ProviderSet, repositorys.ProviderSet, controllers.ProviderSet, grpcservers.ProviderSet)
